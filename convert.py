...
def find_first_url(text):
    pattern =
    'https://raw.githubusercontent.com/snakem982/proxypool/main/mihomo[a-zA-Z0-9]*?.ymal'
...
response_github = requests.get(
    'https://raw.githubusercontent.com/snakem982/proxypool/main/README.md',
    headers = headers)
